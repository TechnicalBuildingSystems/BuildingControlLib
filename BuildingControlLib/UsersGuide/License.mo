within BuildingControlLib.UsersGuide;
class License "Modelica License 2"
 ...
 <p>
 <strong>Licensed by Fraunhofer Institute for Building Physics IBP under the Modelica License 2 </strong>
 </p>
 ...
 You are under no obligation whatsoever to provide any bug fixes, patches, or upgrades to the features, functionality or performance of the source code (\"Enhancements\") to anyone; however, if you choose to make your Enhancements available either publicly, or directly to Fraunhofer Institute for Building Physics IBP, without imposing a separate written license agreement for such Enhancements, then you hereby grant the following license: a non-exclusive, royalty-free perpetual license to install, use, modify, prepare derivative works, incorporate into other computer software, distribute, and sublicense such enhancements or derivative works thereof, in binary and source code form.
 </li></ol>
 ...
 Licensed by Fraunhofer Institute for Building Physics IBP under the Modelica License 2 Copyright (c) 2017, Fraunhofer Institute for Building Physics IBP.
 </li>

...
model AirHandlingUnitControlStateGraph
...
equation
  ...
  connect(controlBus, modeSelector.cb) annotation (Line(
      points={{-240,-260},{-72,-260},{-72,-213.535},{-100.378,-213.535}},
      color={255,204,51},
      thickness=0.5,
  ...
  connect(modeSelector.cb, TSetCoo.controlBus) annotation (Line(
      points={{-100.378,-213.535},{-72,-213.535},{-72,-208},{-41.8,-208}},
      color={255,204,51},
      thickness=0.5,
      smooth=Smooth.None));
...
end AirHandlingUnitControlStateGraph;

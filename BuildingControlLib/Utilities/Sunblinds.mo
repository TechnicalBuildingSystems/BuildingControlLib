...
package Sunblinds "Sunblind models for testing control functions"
  model Sunblind_ControlInput
    "Model of a sunblind which reduces the irradiation on a surface. Sunblind 
  operation is given as an boolean input."
    extends
      AixLib.Building.Components.Weather.Sunblinds.BaseClasses.PartialSunblind;

    Modelica.Blocks.Interfaces.BooleanInput uOperate
      "If uOperate == true then sunblind is delppoyed and amount of irradiation is lowered else irradiation is not altered."
  ...
  equation
     for i in 1:n loop
       if (uOperate) then // Genuine discontiunity
...
<li>Via a boolean input define when the sunblind is deployed and when not</li>
</ul>
...
<p>This model is derived from the model <a href=\"AixLib.Building.Components.Weather.Sunblinds.Sunblind\">Sunblind</a> from the AixLib library <a href=\"https://www.github.com/RWTH-EBC/AixLib\">https://www.github.com/RWTH-EBC/AixLib</a></p>
</html>", revisions="<html>
<ul>
...
<p>This package contains sunblind models used to test building control functions.</p>
</html>"));
end Sunblinds;

within BuildingControlLib.Utilities.Wall;
model Wall_ASHRAE140_mod
...
public
  ...
  BuildingControlLib.Utilities.Sunblind.Sunblind_ControlInput Sunblind(
    n=1,

...
block ControlDriveActuatorFanSpeedFunctionality
  "Algorithm model to provide functionality of ControlDriveActuatorFanSpeed"
  extends
...
<p>Block that implements the functionality of &QUOT;Control drive actuator&QUOT; from VDI 3813 <a href=\"modelica://BuildingControlLib.UsersGuide.References\">[1, section 6.2.4, p. 21 - 22]</a>. For semantic correctness it is specialized for fan speeds.</p>
...
<td valign=\"top\"><p>Output</p></td>
<td valign=\"top\"><p>Physical signal to change fan speed.</p></td>
</tr>
</table>
</html>", revisions="<html>
<ul>
...
end ControlDriveActuatorFanSpeedFunctionality;

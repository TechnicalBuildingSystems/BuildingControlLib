...
block ControlDriveActuatorDamperPositionFunctionality
  "Algorithm model to provide functionality of ControlDriveActuatorDamperPosition"
  extends
...
<p>Block that implements the functionality of &QUOT;Control drive actuator&QUOT; from VDI 3813 <a href=\"modelica://BuildingControlLib.UsersGuide.References\">[1, section 6.2.4, p. 21 - 22]</a>. For semantic correctness it is specialized for damper positions.</p>
...
end ControlDriveActuatorDamperPositionFunctionality;

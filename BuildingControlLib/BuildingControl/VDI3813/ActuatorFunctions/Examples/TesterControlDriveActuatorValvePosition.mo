...
model TesterControlDriveActuatorValvePosition
  "Model for testing the functionality of ControlDriveActuatorValvePosition"
...
<p>Simulation to check the behaviour of the function model of &QUOT;Control drive actuator&QUOT; from VDI 3813 <a href=\"modelica://BuildingControlLib.UsersGuide.References\">[1, section 6.2.4, p. 21 - 22]</a>. For semantic correctness it is specialized for valve positions.</p>

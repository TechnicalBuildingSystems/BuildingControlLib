...
block ControlDriveActuatorLockValvePosition
  "Actuator function to provide a control signal to a physical lock valve actuator"
  ...
  extends
    BuildingControlLib.BuildingControl.VDI3813.Interfaces.Partial.PartialFunction(
                                                   redeclare
      BuildingControlLib.BuildingControl.VDI3813.ActuatorFunctions.Internal.ControlDriveActuatorLockValvePositionFunctionality
      functionality);
  /***   ***   ***   ***   ***   ***   ***   ***   ***   ***/
  // Connectors
...
equation
  ...
  connect(functionality.V_SET_LCK, V_SET_LCK) annotation (Line(
      points={{-26.6,0},{-62,0},{-62,70},{-90,70}},
      color={0,0,0},
      thickness=1,
      smooth=Smooth.None));
...
<p>Block that implements function &QUOT;Control Drive Actuator&QUOT; from VDI 3813 <a href=\"modelica://BuildingControlLib.UsersGuide.References\">[1, section 6.2.4, p. 21 - 22]</a>. For semantic correctness it is specialized for lock valve positions.</p>
...
end ControlDriveActuatorLockValvePosition;

...
block AirTemperatureMeasurementRoom
  ...
  BuildingControlLib.BuildingControl.VDI3813.Interfaces.PhysicalRealInput
    T "Physical signal of an indoor air temperature measurement (expected unit is Kelvin)." annotation (Placement(transformation(extent={{-10,90},{10,110}}),
        iconTransformation(extent={{-20,80},{20,120}})));

  BuildingControlLib.BuildingControl.VDI3813.Interfaces.RealOutput
    T_ROOM "Room air temperature (expected unit is Kelvin)." annotation (Placement(transformation(extent={{100,60},{120,80}}),

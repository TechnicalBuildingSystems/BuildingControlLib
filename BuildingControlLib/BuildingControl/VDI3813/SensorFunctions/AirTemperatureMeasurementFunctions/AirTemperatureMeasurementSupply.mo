...
block AirTemperatureMeasurementSupply
  "Sensor function to retrieve supply air temperature from physical sensor"

  /***   ***   ***   ***   ***   ***   ***   ***   ***   ***/
  // Extend from PartialFunctionBlock and insert specific functionality
  extends Interfaces.Partial.PartialFunction(      redeclare
      BuildingControlLib.BuildingControl.VDI3813.SensorFunctions.Internal.AirTemperatureMeasurementSupplyFunctionality
            functionality(
      slope = PAR_CAL_slope,
  ...
  parameter Real PAR_CAL_slope = 1
    "Slope to calibrate measurement of supply air temperature with a linear equation.";
  parameter Real PAR_CAL_yIntercept = 0
    "Y-axis intercept of linear supply air temperature calibration equation.";
...
equation
  connect(T, functionality.T) annotation (
      ...
      thickness=1,
      smooth=Smooth.None));
  connect(T_SUPPLY, functionality.T_SUPPLY)
    annotation (Line(
...
<p>Block that implements function &QUOT;Air temperature measurement&QUOT; from VDI 3813 <a href=\"modelica://BuildingControlLib.UsersGuide.References\">[1, section 6.1.5, p. 13]</a>. For semantic correctness it is specialized for supply temperatures.</p>
...
<td valign=\"top\"><p>Physical signal of supply air temperature measurement.</p></td>
</tr>
</table>
...
<tr>
<td valign=\"top\"><p>T_SUPPLY</p></td>
<td valign=\"top\"><p>Temperature</p></td>
<td valign=\"top\"><p><a href=\"modelica://BuildingControlLib.BuildingControl.VDI3813.Interfaces.AirTemperature.ValueAirTemperatureSupplyOutput\">ValueAirTemperatureSupply</a> </p></td>
<td valign=\"top\"><p>Output</p></td>
<td valign=\"top\"><p>Supply air temperature of a ventilation system in Kelvin.</p></td>
</tr>
</table>
<p><br><br><br><br><br><b><font style=\"color: #008000; \">Parameters</font></b> </p>
...
<td valign=\"top\"><p>Slope to calibrate measurement of supply air temperature with a linear equation.</p></td>
</tr>
<tr>
<td valign=\"top\"><p>PAR_CAL_yIntercept</p></td>
<td valign=\"top\"><p>Y-axis intercept of linear supply air temperature calibration equation.</p></td>
</tr>
</table>
</html>",
        revisions="<html>
...
end AirTemperatureMeasurementSupply;

...
block AirTemperatureMeasurementSupply
  ...
  BuildingControlLib.BuildingControl.VDI3813.Interfaces.PhysicalRealInput
    T "Physical signal of supply air temperature measurement (expected unit is Kelvin)." annotation (Placement(transformation(extent={{-10,90},{10,110}}),
        iconTransformation(extent={{-20,80},{20,120}})));

  BuildingControlLib.BuildingControl.VDI3813.Interfaces.RealOutput
    T_SUPPLY "Supply air temperature of a ventilation system (expected unit is Kelvin)."   annotation (Placement(transformation(extent={{100,60},{120,80}}),

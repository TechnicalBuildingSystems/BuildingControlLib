...
block AirTemperatureMeasurementOutdoor
  "Sensor function to retrieve outdoor air temperature from physical sensor"

  /***   ***   ***   ***   ***   ***   ***   ***   ***   ***/
  // Extend from PartialFunctionBlock and insert specific functionality
  extends Interfaces.Partial.PartialFunction(      redeclare
      BuildingControlLib.BuildingControl.VDI3813.SensorFunctions.Internal.AirTemperatureMeasurementOutdoorFunctionality
      functionality(
      slope = PAR_CAL_slope,
  ...
  parameter Real PAR_CAL_slope = 1
    "Slope to calibrate measurement of outdoor air temperature with a linear equation.";
  parameter Real PAR_CAL_yIntercept = 0
    "Y-axis intercept of linear outdoor air temperature calibration equation.";
...
<p>Block that implements function &QUOT;Air temperature measurement&QUOT; from VDI 3813 <a href=\"modelica://BuildingControlLib.UsersGuide.References\">[1, section 6.1.5, p. 13]</a>. For semantic correctness it is specialized for outdoor temperatures.</p>
...
end AirTemperatureMeasurementOutdoor;

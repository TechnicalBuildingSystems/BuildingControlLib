...
block AirTemperatureMeasurementSupplyFunctionality
  "Algorithm model to provide functionality of AirTemperatureMeasurementSupply"
  ...
  BuildingControlLib.BuildingControl.VDI3813.Interfaces.Analog.ValuePhysicalTemperatureInput
    T "Physical signal of supply air temperature measurement." annotation (Placement(transformation(extent={{-20,80},{20,120}}),
        iconTransformation(extent={{-20,80},{20,120}})));

  BuildingControlLib.BuildingControl.VDI3813.Interfaces.AirTemperature.ValueAirTemperatureSupplyOutput
    T_SUPPLY "Supply air temperature of a ventilation system in Kelvin." annotation (Placement(transformation(extent={{100,-20},{160,20}}),
        iconTransformation(extent={{100,-20},{160,20}})));

equation
    T_SUPPLY.valueAirTemperatureSupply = slope * T.valuePhysicalTemperature + yIntercept;
...
<p>Block that implements the functionality of &QUOT;Air temperature measurement&QUOT; from VDI 3813 <a href=\"modelica://BuildingControlLib.UsersGuide.References\">[1, section 6.1.5, p. 13]</a>. For semantic correctness it is specialized for supply temperatures.</p>
...
end AirTemperatureMeasurementSupplyFunctionality;

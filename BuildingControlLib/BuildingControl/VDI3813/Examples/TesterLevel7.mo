...
/***   ***   ***   ***   ***   ***   ***   ***   ***   ***/
 ...
 parameter Real startTimeCAL[5] = {0,0,0,0,-1.0}
  ...
  SensorFunctions.BrightnessMeasurementFunctions.BrightnessMeasurementOutdoor
    ...
    annotation (Placement(transformation(extent={{-160,420},{-140,440}})));
  ...
  Modelica.Blocks.Sources.Constant sourceH(k=100000)
    "Source to define brightness of ourdoot illuminance in lux"
    annotation (Placement(transformation(extent={{-224,418},{-204,438}})));
equation
  ...
  connect(occupancyEvaluation.P_ACT, automaticThermalControl.P_ACT) annotation (
     Line(
      points={{-56,248},{-50,248},{-50,130},{-36,130}},
      color={0,0,0},
      thickness=1,
      smooth=Smooth.None));
  connect(brightnessMeasurementOutdoor.H_OUT, automaticThermalControl.H_OUT)
    annotation (Line(
      points={{-137,430},{-110,430},{-110,-28},{-50,-28},{-50,122},{-36,122}},
      color={0,0,0},
      thickness=1,
      smooth=Smooth.None));
  connect(prescribedH.H, brightnessMeasurementOutdoor.H) annotation (Line(
      points={{-178.1,430},{-164,430},{-164,440},{-150,440}},
      color={0,0,0},
      smooth=Smooth.None));
  connect(airTemperatureMeasurementRoom.T_ROOM, automaticThermalControl.T_ROOM)
    annotation (Line(
      points={{-137,366},{-138,366},{-138,366},{-140,366},{-110,366},{-110,-28},
          {-50,-28},{-50,114},{-36,114}},
      color={0,0,0},
      thickness=1,
      smooth=Smooth.None));
  connect(setpointCalculation.T_SETPTS, automaticThermalControl.T_SETPTS)
    annotation (Line(
      points={{-54.6,120},{-50,120},{-50,106},{-36,106}},
      color={0,0,0},
      thickness=1,
      smooth=Smooth.None));
  connect(automaticThermalControl.S_MAN, priorityControl.S_MAN[2]) annotation (
      Line(
      points={{4,120},{10,120},{10,-26},{-110,-26},{-110,172},{-98,172}},
      color={0,0,0},
      thickness=1,
      smooth=Smooth.None));
  connect(sourceH.y, prescribedH.u) annotation (Line(
      points={{-203,428},{-200,428},{-200,430},{-198,430}},
      color={0,0,127},
      smooth=Smooth.None));

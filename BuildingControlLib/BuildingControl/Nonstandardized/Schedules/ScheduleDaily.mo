...
block ScheduleDaily "Model of a schedule with daily periodicity"
...
equation
  connect(combiTimeTable.y[1], y) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  annotation (experiment(StopTime=172800, Interval=1000),
...
<h4><span style=\"color: #008000\">Limitations</span></h4>
This model is implemented using the model <a href=\"modelica://Modelica.Blocks.Sources.CombiTimeTable\">combiTimeTable</a> from Modelica Standard Library.
</html>", revisions="<html>
<ul>
